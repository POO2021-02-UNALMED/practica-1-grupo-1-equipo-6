...
class Ventana(Toplevel):
    def __init__(self, master, bastardos, hijos):
        ...
        self.iniTitulo = Label(master=self.pane0, text="Gestor de Restaurante", height=5,
        ...
        iniImagen = ImageTk.PhotoImage(
            (Image.open("Imagenes\\Ramsay.jpg")).resize((500, 500)), Image.ANTIALIAS)
        ...
        textoPlaceholder = "Esperamos que tenga un buen día usuario.\nPuede acceder a las funcionalidades del sistema\ndesde el menú procesos y consultas, ahí puede:\nFacturar un pedido\nRevisar el estado del restaurante\nRevisar/Reiniciar el estado de la caja\nVer las estadísticas del restaurante\nRevisar o cambiar la jornada del restaurante\nAgregar, eliminar o ver los meseros del restaurante\nAgregar, eliminar o ver las mesas\nVer el menú o agregarle platillos\nAgregar, eliminar o ver los platillos registrados en el sistema\nCrear un pedido\nAgregar platillos a un pedido ya existente"
        self.iniTexto = Label(master=self.pane0, height=25, width=50,
